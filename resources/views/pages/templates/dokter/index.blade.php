                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" >
                                            <div class="btn-group" role="group"  >
                                                ...
                                                <a href="{{ route('dokter.histori', $data->id) }}" class="btn btn-secondary">Histori</a>
                                                <a href="{{ route('dokter.edit', $data->id) }}" class="btn btn-success">Edit</a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
                        ...
                        <script>
                            ...
                            for (let btnDelete of btnDeletes) {
                                btnDelete.addEventListener('click', function(){
                                    ...
                                    btnFinalDelete.setAttribute("href", `dokter/${this.dataset.id}/delete`)
                                })
                            }
                        </script>
                    </div>
