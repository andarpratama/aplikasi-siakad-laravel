            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between border-bottom">
                        ...
                        <div>
                            <a href="{{ route('pasien.create') }}" class="btn btn-primary"><i class="align-middle me-2" data-feather="file-plus"></i>Data {{ $title }}</a>
                        </div>
                    </div>
                    <div class="card-body">
                        @if (session('message'))
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" >
                                            <div class="btn-group" role="group"  >
                                                ...
                                                <a href="{{ route('pasien.show', $data->id) }}" class="btn btn-warning">Detail</a>
                                                <a href="{{ route('pasien.histori', $data->id) }}" class="btn btn-secondary">Histori</a>
                                                <a href="{{ route('pasien.edit', $data->id) }}" class="btn btn-success">Edit</a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
                        ...
                        <script>
                            ...
                            for (let btnDelete of btnDeletes) {
                                btnDelete.addEventListener('click', function(){
                                    ...
                                    btnFinalDelete.setAttribute("href", `pasien/${this.dataset.id}/delete`)
                                })
                            }
                        </script>
                    </div>
