								...
								<div class="m-sm-4">
									<form method="POST" action="{{ route('register') }}" >
										...
										<div class="mb-3">
											...
											<input class="form-control form-control-lg" type="text" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus />
                                            @error('name')
										...
										<div class="mb-3">
											...
											<input class="form-control form-control-lg" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" />
                                            @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
										...
										<div class="text-center mt-3 d-flex flex-column">
											...
											<button type="submit" class="btn btn-block btn-lg btn-primary py-2">Sign up</button>
										</div>
									</form>
								</div>
							</div>
